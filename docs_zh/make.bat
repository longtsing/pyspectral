...
REM Command file for Sphinx documentation (中文版)
...
if "%1" == "qthelp" (
	...
	echo.^> qcollectiongenerator %BUILDDIR%\qthelp\Pyspectral.qhcp
	echo.To view the help file:
	echo.^> assistant -collectionFile %BUILDDIR%\qthelp\Pyspectral.ghc
	goto end
)
